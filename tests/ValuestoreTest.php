...
class ValuestoreTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->valuestore->put('number', 1)->put('string', 'hello');
        $this->assertSame(1, $this->valuestore->get('number'));
    ...
    public function it_can_fetch_all_values_at_once()
    {
        ...
        $this->assertSame(['key' => 'value', 'otherKey' => 'otherValue'], $this->valuestore->all());
    }
    /** @test */
    public function it_can_store_multiple_value_pairs_in_one_go()
    {
        $values = ['key' => 'value', 'otherKey' => 'otherValue'];
    ...
    public function it_can_store_values_without_forgetting_the_old_values()
    {
        ...
        $this->assertSame(['test1' => 'value1', 'test2' => 'value2'], $this->valuestore->all());
        $this->valuestore->put(['test3' => 'value3']);
        $this->assertSame(['test1' => 'value1', 'test2' => 'value2', 'test3' => 'value3'], $this->valuestore->all());
    }
    /** @test */
    public function it_can_fetch_all_values_starting_with_a_certain_value()
    {
        $this->valuestore->put(['group1Key1' => 'valueGroup1Key1', 'group1Key2' => 'valueGroup1Key2', 'testgroup1' => 'valueTestGroup1', 'group2Key1' => 'valueGroup2Key1', 'group2Key2' => 'valueGroup2Key2']);
        $expectedArray = ['group1Key1' => 'valueGroup1Key1', 'group1Key2' => 'valueGroup1Key2'];
    ...
    {
        $this->valuestore->put(['group1' => 'valueGroup1', 'group1Key1' => 'valueGroup1Key1', 'group1Key2' => 'valueGroup1Key2', 'group2Key1' => 'valueGroup2Key1', 'group2Key2' => 'valueGroup2Key2']);
        $this->valuestore->flushStartingWith('group1');
        $expectedArray = ['group2Key1' => 'valueGroup2Key1', 'group2Key2' => 'valueGroup2Key2'];
